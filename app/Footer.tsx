    ...
    <footer className="bg-neutral-800 pt-9 pb-4">
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-6 max-w-5xl">
        <div className="w-full flex flex-col md:flex-row">
          <div className="w-full flex flex-col gap-3 mb-5 md:mb-0 justify-center items-center">
            <img
              src='https://assetwise.co.th/wp-content/themes/seed-spring/img/th/logo-asw.png'
              alt="AssetWise Logo"
              width="160"
              height="35"
              className="w-[160px] h-auto"
            />
            <h4 className="text-white text-[22px] mb-2">ติดตามแอสเซทไวส์</h4>
            <div className="social-listed flex w-full gap-3 justify-center">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center bg-white rounded-full hover:bg-purple-900 hover:text-white transition-all"
                >
                  <svg
            ...
            <div className="w-full flex flex-col gap-3 mb-5 md:mb-0 justify-center items-center">
              <a href="tel:021680000" className="text-white text-[22px] mt-5">02-168-0000</a>
            </div>
          </div>
