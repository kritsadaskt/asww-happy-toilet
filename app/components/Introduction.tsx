  ...
  return(
    <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-5xl">
      ...
      <section className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 border-t-4 border-primary">
        ...
        <p className="mb-4">
        บริษัท แอสเซทไวส์ จำกัด (มหาชน) หรือ ASW ขอเชิญ สถาปนิกอิสระ ประชาชนทั่วไป และนักเรียน/นิสิต/นักศึกษา ผู้เปี่ยมความคิดสร้างสรรค์และหัวใจเพื่อส่วนรวม มาร่วมออกแบบ “ห้องน้ำที่สร้างความสุขให้ทุกคน” พื้นที่สาธารณะที่สะอาด ปลอดภัย ใช้งานง่าย เท่าเทียม และยั่งยืน เพื่อยกระดับมาตรฐานใหม่ให้กับห้องน้ำสาธารณะไทยสำหรับทุกคนอย่างแท้จริง
        </p>
